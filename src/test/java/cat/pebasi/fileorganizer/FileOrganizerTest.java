...
import cat.pebasi.fileorganizer.spies.ImaagingAdapterSpy;
...
public class FileOrganizerTest {
	...
	private ImaagingAdapterSpy imagingAdapter;
	...
	private void beforeMethod() {
		...
		imagingAdapter = new ImaagingAdapterSpy();
	...
	public void testLoggerInit() throws Exception {
		FileOrganizer.setImagingAdapter(imagingAdapter);
		FileOrganizer.main(argsBasePath);

		loggerFactorySpy.MCR.assertParameters("factorForClass", 0, FileOrganizer.class);
	...
	public void testCallsImagingAdapter() throws Exception {
		...
		FileOrganizer.main(argsOnlyImagesPath);
	...
	public void testAcceptOnlyImageFormat_JPG_otherwiseLogFilesWhichAreNotProcessed()
		...
		FileOrganizer.main(argsOnlyNonImagesPath);
		List<String> imageFilesWhenCreated = fileOrganizer.getFilesToOrganize();
	...
	public void testPathMightBeAFile() throws Exception {
		...
		FileOrganizer.main(argsToAnImage);
		fileOrganizer.getFilesToOrganize();
	...
	public void testNotExistingPath() throws Exception {
		...
		FileOrganizer.main(notExistingPath);
		fileOrganizer.getFilesToOrganize();
